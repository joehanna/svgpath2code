...
namespace Poupou.SvgPathConverter
{
  ...
  public static class FormatterRocks
  {
    ...
    public static void ArcHelper(this ISourceFormatter formatter,
                                PointF size,
                                float anglef, 
                                bool isLarge,
                                bool sweep,
                                ...
                                PointF startPoint)
    {
      ...
      double at = Math.Atan2(((y1p - cyp) / ry),
                           ((x1p - cxp) / rx));
      double theta1 = (at < 0.0) ? 2.0 * Math.PI + at : at;
			
      double nat = Math.Atan2(((-y1p - cyp) / ry),
                            ((-x1p - cxp) / rx));
      ...
      PointF c1 = new PointF(0,
                              0);
      PointF c2 = new PointF(0,
                              0);
